...
public class Biblioteca {
    ...
    /**
     * Agrega un libro a una libreria de la biblioteca
     *
     */
    public void agregarLibro(String titulo, String autor, Clasificacion clasificacion, String editorial, int agno, int edicion, int nroEjemplares, int librero){
        libreros.get(librero-1).agregarEjemplares(titulo,autor, clasificacion,editorial, agno,edicion,nroEjemplares);
    }

    /**
     * Agrega un librero a la biblioteca
     * @param nombre del librero
     */
    public void agregarLibrero(String nombre){
        Librero l1 = new Librero(nombre);
        libreros.add(l1);
    }

    /**
     * Itera por todos los libreros mostrando el nombre
     */
